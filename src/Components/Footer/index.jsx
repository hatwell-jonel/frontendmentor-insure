...
// IMPORTED IMAGES
import mobBg from '../../images/bg-pattern-footer-mobile.svg';
import dtBg from '../../images/bg-pattern-footer-desktop.svg';
...
function Footer() {
  return (
    <footer className="footer">
      <img src={mobBg} className='mob-bg' alt="" />
      <img src={dtBg} className='dt-bg' alt="" />
      <div className="container">
        ...
        <div className="links-container">
          <ul className="links">
            <li className='link-item '>our company</li>
          ...
          <ul className="links">
            <li className='link-item '>help me</li>
            <li className='link-item'>
              <a href="#">faq</a>
            </li>
            <li className='link-item'>
          ...
          <ul className="links">
            <li className='link-item '>others</li>
            <li className='link-item'>
              <a href="#">careers</a>
            </li>
            <li className='link-item'>
